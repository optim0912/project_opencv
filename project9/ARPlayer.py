...
# 기준 영상 불러오기
src = cv2.imread('Scan0001.jpg', cv2.IMREAD_GRAYSCALE)
size_h, size_w = src.shape[:2]
...
while True:
    ...
    if len(kp2) > 100:
        ...
        dst = cv2.drawMatches(src, kp1, frame1, kp2, good_matches, None,
        ...
        if inlier_cnt > 20:
            ...
            frame2 = cv2.resize(frame2, (size_w, size_h))
